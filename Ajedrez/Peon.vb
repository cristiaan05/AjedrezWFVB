Public Class Peon
    ...
    Private movimientos(7, 7) As Boolean
    ...
    Public Sub movimientosBlanco()
        If posicionY = 6 Then
            If Ajedrez.tableroPosiciones(posicionY - 1, posicionX) = 0 And posicionY < 7 And ameRey = False Then
                movimientos(posicionY - 1, posicionX) = True
            End If
            If Ajedrez.tableroPosiciones(posicionY - 2, posicionX) = 0 And Ajedrez.tableroPosiciones(posicionY - 1, posicionX) = 0 And ameRey = False Then
                movimientos(posicionY - 2, posicionX) = True
            End If
            If posicionX + 1 <= 7 And posicionY - 1 >= 0 Then
                If Ajedrez.tableroPosiciones(posicionY - 1, posicionX + 1) < 0 Then
                    movimientos(posicionY - 1, posicionX + 1) = True
                End If
            End If
            If posicionY - 1 >= 0 And posicionX - 1 >= 0 Then
                If Ajedrez.tableroPosiciones(posicionY - 1, posicionX - 1) < 0 Then
                    movimientos(posicionY - 1, posicionX - 1) = True
                End If
            End If
        Else
            If posicionY - 1 >= 0 Then
                If Ajedrez.tableroPosiciones(posicionY - 1, posicionX) = 0 And ameRey = False Then
                    movimientos(posicionY - 1, posicionX) = True
                End If
            End If
    ...
    Public Sub movimientosNegro()
        If posicionY = 1 Then
            ...
            If posicionX + 1 <= 7 And posicionY + 1 <= 7 Then
                ...
                End If
            End If
            If posicionY + 1 <= 7 And posicionX - 1 >= 0 Then
                If Ajedrez.tableroPosiciones(posicionY + 1, posicionX - 1) > 0 Then
                    movimientos(posicionY + 1, posicionX - 1) = True
                End If
            End If
    ...
    Public Sub MoverPeon(posY As Integer, posX As Integer, posSelY As Integer, posSelX As Integer)
